const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.6LzDWYKu.js","assets/chunks/framework.Cj9_MUzw.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.6LzDWYKu.js"), true ? __vite__mapDeps([0,1]) : void 0));
