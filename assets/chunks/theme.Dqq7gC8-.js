...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.Ci7qOLXi.js"), true ? __vite__mapDeps([0,1]) : void 0));
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(page).relativePath === "ROS2_INTERFACE_REFERENCE.md" ? (openBlock(), createElementBlock("nav", _hoisted_1, [
          ...
          (openBlock(), createElementBlock(Fragment, null, renderList(groups, (group) => {
            return createBaseVNode("li", {
              ...
              createBaseVNode("details", {
                class: "api-outline-section",
                open: group.open
              }, [
                createBaseVNode("summary", null, [
                  createTextVNode(toDisplayString(group.title), 1),
                  createBaseVNode("span", null, toDisplayString(counts.value[group.count] ?? "—"), 1)
                ]),
                createBaseVNode("ul", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(group.items, (item) => {
                    return openBlock(), createElementBlock("li", {
                      ...
                      createBaseVNode("a", {
                        ...
                        createBaseVNode("small", null, toDisplayString(counts.value[item.count] ?? "—"), 1)
                      ], 8, _hoisted_3)
                    ]);
                  }), 128))
                ])
        ...
        _cache[2] || (_cache[2] = createBaseVNode("p", { class: "api-count-note" }, "数量是文档收录的接口数。Type 可查看字段与调用示例。", -1))
      ])) : createCommentVNode("", true);
    };
  }
});
