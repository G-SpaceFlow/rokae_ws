    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Services（17）',
            link: '/ROS2_INTERFACE_REFERENCE#_2-4-底层控制-services-17',
          },
          {
            text: '状态数据详解',
          ...
          {
            text: 'MoveL',
            link: '/ROS2_INTERFACE_REFERENCE#_8-movel-services',
          },
          {
            text: '初始化与回原',
            link: '/ROS2_INTERFACE_REFERENCE#_9-初始化与回原服务',
          },
          {
            text: '灵巧手',
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: '参数参考',
            link: '/ROS2_INTERFACE_REFERENCE#_11-参数参考',
          },
          {
            text: '控制权与并发',
            link: '/ROS2_INTERFACE_REFERENCE#_12-控制权、并发和状态语义',
          },
          {
            text: '未实现接口',
            link: '/ROS2_INTERFACE_REFERENCE#_13-未实现接口',
          },
          {
            text: '安全要求',
            link: '/ROS2_INTERFACE_REFERENCE#_16-安全使用要求',
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '视觉目标',
            link: '/ROS2_INTERFACE_REFERENCE#_14-上层视觉目标接口',
          },
          {
            text: '底盘桥接',
            link: '/ROS2_INTERFACE_REFERENCE#_15-可选底盘桥接接口',
          },
          {
            text: '实现位置',
            link: '/ROS2_INTERFACE_REFERENCE#_17-实现位置',
          },
        ],
      },
    ],
